...
/* SQL Statement */
/** Use UPDATE **/
UPDATE teacher SET tLname = ????? where tUname = 'jha';
UPDATE teacher SET tLname = ????? where tUname = 'mikki';
UPDATE teacher SET tLname = ????? where tUname = 'sattav';
UPDATE teacher SET tLname = ????? where tUname = 'bigboy';
